...
def passInfo():
    ...
    response = mysession.post(
        url, data=data, headers=headers, verify=False, timeout=5, allow_redirects=False)
    mysession.cookies.save()
...
if __name__ == "__main__":
    ...
    response = mysession.post(
        url, json=data, headers=headers, verify=False, timeout=5, allow_redirects=False)
    ...
    response = mysession.post(url, headers=headers,
                              verify=False, timeout=5, allow_redirects=False)
    body = response.json()
